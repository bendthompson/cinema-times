...
st.title('Meguro Cinema')

length=6
rows=length//4
rem=length%4

imgs=['https://imdb-api.com/images/384x528/MV5BZWMyYzFjYTYtNTRjYi00OGExLWE2YzgtOGRmYjAxZTU3NzBiXkEyXkFqcGdeQXVyMzQ0MzA0NTM@._V1_Ratio0.7273_AL_.jpg',
...
moviedetails = [{'title': 'Spider-Man: No Way Home',
 'year': '2021',
 'runtimeMins': '148',
 'runtimeStr': '2h 28min',
